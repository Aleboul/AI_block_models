...
\begin{algorithmic}[1]
\Procedure{Clust}{$S$, $\alpha$, $\hat{\textbf{R}}$}
...
\end{algorithm}
    ...
    \label{fig:chiab}
                \begin{subfigure}{.5\textwidth}
                  \centering
                  \includegraphics[width=.9\linewidth,height=5.5cm]{figure/chiab.pdf}
                  \caption{Estimated ($\chi(a,b)$)}
                  \label{fig:sfig_chiab}
                \end{subfigure}%
                \begin{subfigure}{.5\textwidth}
                  \centering
                  \includegraphics[width=.9\linewidth,height=5.5cm]{figure/chiab_sampled.pdf}
                  \caption{Reordering of estimated ($\chi(a,b)$)}
